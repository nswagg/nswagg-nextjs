      ...
      <div className="bg-slate-100 overflow-hidden">
        ...
        <div id="projects" className="pt-0 md:pt-32 pb-12 bg-gradient-to-b from-slate-100 to-slate-400">
          <Projects>
            ...
            <ProjectItem title="CFA GIS Delivery Zone Optimization" href="/cfagis" description="Mapbox GIS visualization using historic delivery data to inform delivery zone optimization through speed of service"/>
